...
final class GlobalServiceTypeController extends Controller
{
    ...
    {
        $record = $this->globalServiceTypes->create($request->validated());

        return redirect()
            ->route('config.global-service-types.edit', $record)
    ...
    public function update(UpdateGlobalServiceTypeRequest $request, GlobalServiceType $globalServiceType): RedirectResponse
    {
        ...
        return redirect()
            ->route('config.global-service-types.edit', $globalServiceType)
