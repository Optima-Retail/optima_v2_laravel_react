...
final class BulkUpdateWorkOrderStatusRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('work_orders.update') ?? false;
    }
        ...
        return [
            ...
            'status_id' => [
                ...
                Rule::exists('work_order_statuses', 'id')->where(
                    fn ($query) => $query
                        ->where('kind', WorkOrderStage::WorkOrder->value)
