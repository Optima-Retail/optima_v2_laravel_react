...
final class UpdateClientPriorityRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var ClientPriority $clientPriority */
        $clientPriority = $this->route('client_priority');

        return $this->user()?->can('update', $clientPriority) ?? false;
    }
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'code' => [
                ...
                'max:50',
                'alpha_dash',
                Rule::unique('client_priorities', 'code')
                    ->whereNull('deleted_at')
                    ->ignore($clientPriority->id),
            ],
