...
final class UpdateFormStatusRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var FormStatus $formStatus */
        $formStatus = $this->route('form_status');

        return $this->user()?->can('update', $formStatus) ?? false;
    }
