...
final class UpdateTechnicianRequestStatusRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var TechnicianRequestStatus $technicianRequestStatus */
        $technicianRequestStatus = $this->route('technician_request_status');

        return $this->user()?->can('update', $technicianRequestStatus) ?? false;
    }
