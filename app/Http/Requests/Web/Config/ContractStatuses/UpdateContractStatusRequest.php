...
namespace App\Http\Requests\Web\Config\ContractStatuses;

use App\Models\ContractStatus;
use Illuminate\Foundation\Http\FormRequest;

final class UpdateContractStatusRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var ContractStatus $contractStatus */
        $contractStatus = $this->route('contract_status');

        return $this->user()?->can('update', $contractStatus) ?? false;
    }
