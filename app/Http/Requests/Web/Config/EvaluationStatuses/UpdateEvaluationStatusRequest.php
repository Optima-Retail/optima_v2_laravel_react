...
final class UpdateEvaluationStatusRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var EvaluationStatus $evaluationStatus */
        $evaluationStatus = $this->route('evaluation_status');

        return $this->user()?->can('update', $evaluationStatus) ?? false;
    }
