...
final class StoreFieldHelpRequest extends FormRequest
{
    public function authorize(): bool
    {
        return $this->user()?->can('create', FieldHelp::class) ?? false;
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'key' => ['required', 'string', 'max:191', 'regex:/^[a-z][a-z0-9_]*\.[a-z][a-z0-9_]*$/', Rule::unique('field_helps', 'key')],
