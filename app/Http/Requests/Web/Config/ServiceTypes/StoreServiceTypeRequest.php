...
namespace App\Http\Requests\Web\Config\ServiceTypes;

use App\Models\ServiceType;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Validation\Rule;

final class StoreServiceTypeRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => [
                ...
                'max:50',
                'alpha_dash',
                Rule::unique('service_types', 'code')->whereNull('deleted_at'),
            ],
