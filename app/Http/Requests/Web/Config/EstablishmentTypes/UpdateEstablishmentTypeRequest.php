...
final class UpdateEstablishmentTypeRequest extends FormRequest
{
    public function authorize(): bool
    {
        /** @var EstablishmentType $establishmentType */
        $establishmentType = $this->route('establishment_type');

        return $this->user()?->can('update', $establishmentType) ?? false;
    }
