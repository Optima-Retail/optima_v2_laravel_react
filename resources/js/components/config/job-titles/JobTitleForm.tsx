...
type JobTitleFormProps = {
    ...
    errors: Partial<Record<keyof JobTitleFormValues, string>>;
    processing: boolean;
    onChange: (key: keyof JobTitleFormValues, value: string) => void;
...
export function JobTitleForm({
    ...
    return (
        <FieldHelpScope table="job_titles">
        <form onSubmit={onSubmit} className="space-y-5 rounded-2xl border border-line bg-surface p-6 sm:p-8">
            ...
            <Field label={t('common.code')} htmlFor="code" error={errors.code} required>
                <Input
                    id="code"
                    value={values.code}
                    placeholder={t('jobTitles.codePlaceholder')}
