...
const configItems: ConfigItem[] = [
    ...
    },
    {
        ...
        matches: ['/config/contract-statuses', '/config/evaluation-statuses', '/config/form-statuses', '/config/incident-statuses', '/config/work-order-statuses'],
        icon: CircleDot,
        anyPermissions: ['contract_statuses.view', 'evaluation_statuses.view', 'form_statuses.view', 'incident_statuses.view', 'work_order_statuses.view'],
    },
    {
        href: '/config/teams',
        labelKey: 'nav.teams',
