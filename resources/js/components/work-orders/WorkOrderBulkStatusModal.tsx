...
type WorkOrderBulkStatusModalProps = {
    open: boolean;
...
export function WorkOrderBulkStatusModal({
    open,
    selectedCount,
    statusOptions,
    processing = false,
    ...
    return (
        <BaseModal
            ...
            size="md"
            title={t('workOrders.bulkStatusTitle')}
            description={t('workOrders.bulkStatusDescription', { count: selectedCount })}
            footer={
                <div className="flex justify-end gap-2">
                    ...
                    >
                        {t('workOrders.bulkStatusConfirm')}
                    </Button>
                </div>
            }
        >
            <div className="space-y-4">
                <Field label={t('workOrders.status')} htmlFor="bulk-status-id" required helpField={false}>
                    <SearchableSelect
                        id="bulk-status-id"
                        value={statusId}
