...
export type ContractFormSection = 'details' | 'iterations' | 'aggregations' | 'all';
...
type ContractFormProps = {
    ...
    actions?: ReactNode;
    /** Which form block to render. Defaults to the full form. */
...
export function ContractForm({
    ...
    const scheduleSections: ContractScheduleSection[] | null =
        section === 'all'
            ? ['aggregations', 'iterations']
            : section === 'iterations'
              ? ['iterations']
